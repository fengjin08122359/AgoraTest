(function($) {
    ...
    $(function() {
        var resolution = param["resolution"]||Cookies.get("resolution") || "720p",
			...
			visitorName = decodeURIComponent(param["visitor"]||"")||Cookies.get("visitor");
        ...
        function subscribeMouseClickEvents() {
            ...
            $(".end-call-button,.list-hang-up-btn").click(function(e) {
                client.leave();
				window.close();
				//$("#close").attr("src","http://127.0.0.1:8080/Any800Chat/closeChat.html");
				//parent.videoClose();
